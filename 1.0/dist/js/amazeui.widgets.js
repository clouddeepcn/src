/*! Amaze UI v1.0.2 ~ widgets | by Amaze UI Team | (c) 2015 AllMobilize, Inc. | Licensed under MIT | 2015-01-13T01:01:16 UTC */ 
...
define("ui.offcanvas", [ "zepto.outerdemension", "zepto.extend.data", "core", "zepto.extend.fx", "zepto.extend.selector", "util.fastclick" ], function(require, exports, module) {
   ...
   */
    ...
    OffCanvas.prototype.open = function(relatedElement) {
        ...
        this.active = 1;
        $element.off(".offcanvas.amui").on("click.offcanvas.amui", $.proxy(function(e) {
            var $target = $(e.target);
