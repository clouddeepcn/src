/*! Amaze UI v2.0.0-dp1 ~ AMD | by Amaze UI Team | (c) 2014 AllMobilize, Inc. | Licensed under MIT | 2014-11-12T03:11:56 UTC */
define('amazeui', ['require', 'exports', 'module', 'jquery', './core',
  './util.fastclick', './util.hammer', './ui.add2home', './ui.alert',
  './ui.button', './ui.collapse', './ui.dimmer', './ui.dropdown',
  './ui.flexslider', './ui.iscroll-lite', './ui.modal', './ui.offcanvas',
  './ui.pinchzoom', './ui.popover', './ui.progress', './ui.pureview',
  './ui.scrollspy', './ui.scrollspynav', './ui.share', './ui.smooth-scroll',
  './ui.sticky', './ui.tabs', './util.cookie', './util.fullscreen',
  './util.qrcode', './accordion', './divider', './duoshuo', './figure',
  './footer', './gallery', './gotop', './header', './intro', './list_news',
  './map', './mechat', './menu', './navbar', './pagination', './paragraph',
...
define('core', ['require', 'exports', 'module', 'jquery', './util.fastclick'],
  function(require, exports, module) {
    'use strict';
...
define('util.fastclick', ['require', 'exports', 'module', 'jquery'], function(
   ...
   * @type boolean
   */
  var deviceIsIOSWithBadTarget = deviceIsIOS && (/OS ([6-9]|\d{2})_\d/).test(
    navigator.userAgent);
  ...
  FastClick.prototype.focus = function(targetElement) {
    ...
    if (deviceIsIOS && targetElement.setSelectionRange && targetElement.type.indexOf(
      'date') !== 0 && targetElement.type !== 'time') {
  ...
  FastClick.prototype.touchHasMoved = function(event) {
    ...
    if (Math.abs(touch.pageX - this.touchStartX) > boundary || Math.abs(touch
      .pageY - this.touchStartY) > boundary) {
      return true;
    }
  ...
  FastClick.notNeeded = function(layer) {
    ...
    chromeVersion = +(/Chrome\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[
      1];
...
define('util.hammer', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    ...
    Input.prototype = {
      ...
      init: function() {
        ...
        this.evWin && addEventListeners(getWindowForElement(this.element), this
    ...
    function computeInputData(manager, input) {
      ...
      input.scale = firstMultiple ? getScale(firstMultiple.pointers, pointers) :
        1;
    ...
    function computeIntervalInputData(session, input) {
      ...
      if (input.eventType != INPUT_CANCEL && (deltaTime > COMPUTE_INTERVAL ||
    ...
    function getRotation(start, end) {
      return getAngle(end[1], end[0], PROPS_CLIENT_XY) - getAngle(start[1],
        start[0], PROPS_CLIENT_XY);
    }
    ...
    inherit(SingleTouchInput, Input, {
      handler: function TEhandler(ev) {
        ...
        if (type & (INPUT_END | INPUT_CANCEL) && touches[0].length - touches[
          1].length === 0) {
          this.started = false;
        }
    ...
    Recognizer.prototype = {
      ...
      emit: function(input) {
        ...
        function emit(withState) {
          self.manager.emit(self.options.event + (withState ? stateStr(state) :
            ''), input);
        }
    ...
    inherit(PanRecognizer, AttrRecognizer, {
      ...
      attrTest: function(input) {
        return AttrRecognizer.prototype.attrTest.call(this, input) &&
          (this.state & STATE_BEGAN || (!(this.state & STATE_BEGAN) && this.directionTest(
            input)));
      },
    ...
    inherit(PinchRecognizer, AttrRecognizer, {
      ...
      attrTest: function(input) {
        return this._super.attrTest.call(this, input) &&
          (Math.abs(input.scale - 1) > this.options.threshold || this.state &
            STATE_BEGAN);
      },
    ...
    inherit(PressRecognizer, Recognizer, {
      ...
      process: function(input) {
        ...
        if (!validMovement || !validPointers || (input.eventType & (INPUT_END |
    ...
    Manager.prototype = {
      ...
      recognize: function(inputData) {
        ...
        while (i < recognizers.length) {
          ...
          if (!curRecognizer && recognizer.state & (STATE_BEGAN | STATE_CHANGED |
            STATE_ENDED)) {
...
define('ui.add2home', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
    ...
    _extend(ath, {
      hasToken: document.location.hash == '#ath' || _reSmartURL.test(document
        .location.href) || _reQueryString.test(document.location.search),
    ...
    ath.isMobileSafari = ath.isIDevice && _ua.indexOf('Safari') > -1 && _ua.indexOf(
      'CriOS') < 0;
    ath.OS = ath.isIDevice ? 'ios' : ath.isMobileChrome ? 'android' : ath.isMobileIE ?
      'windows' : 'unsupported';

    ath.OSVersion = _ua.match(/(OS|Android) (\d+[_\.]\d+)/);
    ath.OSVersion = ath.OSVersion && ath.OSVersion[2] ? +ath.OSVersion[2].replace(
      '_', '.') : 0;
    ...
    ath.isTablet = (ath.isMobileSafari && _ua.indexOf('iPad') > -1) || (ath.isMobileChrome &&
      _ua.indexOf('Mobile') < 0);
    ...
    ath.Class = function(options) {
      ...
      this.options.detectHomescreen = this.options.detectHomescreen === true ?
    ...
    ath.Class.prototype = {
      ...
      show: function(force) {
        ...
        if (force !== true) {
          ...
          if (this.options.maxDisplayCount && this.session.displayCount >= this
        ...
        if (this.options.message in ath.intl) { // you can force the locale
          ...
          message = ath.intl[ath.language].message.replace('%action', ath.intl[
            ath.language].action[ath.OS]);
        }
        ...
        this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS +
          (ath.OSVersion + '').substr(0, 1) + ' ath-' + (ath.isTablet ?
          'tablet' : 'phone');
        ...
        this.element.style.webkitTransform = 'translate3d(0,-' + window.innerHeight +
          'px,0)';
      ...
      updateViewport: function() {
        ...
        var screenWidth = ath.OS == 'ios' ? this.orientation == 'portrait' ?
    ...
    function _removeToken() {
      if (document.location.hash == '#ath') {
        history.replaceState('', window.document.title, document.location.href.split(
          '#')[0]);
      }

      if (_reSmartURL.test(document.location.href)) {
        history.replaceState('', window.document.title, document.location.href.replace(
          _reSmartURL, '$1'));
      }
...
define('ui.alert', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.button', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.collapse', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.dimmer', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.dropdown', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.flexslider', ['require', 'exports', 'module', 'jquery'], function(
  require, exports, module) {
  var $ = require('jquery');
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      init: function() {
        ...
        slider.currentSlide = parseInt((slider.vars.startAt ? slider.vars.startAt :
          0), 10);
        if (isNaN(slider.currentSlide)) slider.currentSlide = 0;
        slider.animatingTo = slider.currentSlide;
        slider.atEnd = (slider.currentSlide === 0 || slider.currentSlide ===
          slider.last);
        slider.containerSelector = slider.vars.selector.substr(0, slider.vars
          .selector.search(' '));
        ...
        if (slider.vars.mousewheel) {
          slider.bind('mousewheel', function(event, delta, deltaX, deltaY) {
            event.preventDefault();
            var target = (delta < 0) ? slider.getTarget('next') : slider.getTarget(
              'prev');
            slider.flexAnimate(target, slider.vars.pauseOnAction);
          });
        }
        ...
        if (slider.vars.slideshow) {
          ...
          if (!slider.vars.pauseInvisible || !methods.pauseInvisible.isHidden()) {
            (slider.vars.initDelay > 0) ? slider.startTimeout = setTimeout(
              slider.play, slider.vars.initDelay) : slider.play();
          }
        }
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              if ('thumbnails' === slider.vars.controlNav && true === slider.vars
                .thumbCaptions) {
        ...
        update: function(action, pos) {
          ...
          (slider.pagingCount > 1 && slider.pagingCount !== slider.controlNav
            .length) ? slider.update(pos, action) : methods.controlNav.active();
        }
      },
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace +
            ...
            slider.vars.prevText + '</a></li><li><a class="' + namespace +
            'next" href="#">' + slider.vars.nextText + '</a></li></ul>');
          ...
          slider.directionNav.bind(eventType, function(event) {
            ...
            if (watchedEvent === "" || watchedEvent === event.type) {
              target = ($(this).hasClass(namespace + 'next')) ? slider.getTarget(
                'next') : slider.getTarget('prev');
              slider.flexAnimate(target, slider.vars.pauseOnAction);
            }
          ...
          if (slider.pagingCount === 1) {
            ...
            if (slider.animatingTo === 0) {
              slider.directionNav.removeClass(disabledClass).filter('.' +
                namespace + "prev").addClass(disabledClass).attr('tabindex',
                '-1');
            } else if (slider.animatingTo === slider.last) {
              slider.directionNav.removeClass(disabledClass).filter('.' +
                namespace + "next").addClass(disabledClass).attr('tabindex',
                '-1');
            } else {
          ...
          function onTouchStart(e) {
            if (slider.animating) {
              ...
              offset = (carousel && reverse && slider.animatingTo === slider.last) ?
                ...
                (reverse) ? (slider.last - slider.currentSlide + slider.cloneOffset) *
                cwidth : (slider.currentSlide + slider.cloneOffset) * cwidth;
              ...
              if (!fade && slider.transitions) {
                if (!slider.vars.animationLoop) {
                  dx = dx / ((slider.currentSlide === 0 && dx < 0 || slider.currentSlide ===
                      slider.last && dx > 0) ? (Math.abs(dx) / cwidth + 2) :
                    1);
                }
          ...
          function onTouchEnd(e) {
            ...
            if (slider.animatingTo === slider.currentSlide && !scrolling && !
              ...
              var updateDx = (reverse) ? -dx : dx,
                target = (updateDx > 0) ? slider.getTarget('next') : slider.getTarget(
                  'prev');

              if (slider.canAdvance(target) && (Number(new Date()) - startT <
                550 && Math.abs(updateDx) > 50 || Math.abs(updateDx) >
                cwidth / 2)) {
                slider.flexAnimate(target, slider.vars.pauseOnAction);
              } else {
                if (!fade) slider.flexAnimate(slider.currentSlide, slider.vars
                  .pauseOnAction, true);
              }
            }
      ...
      pauseInvisible: {
        ...
        init: function() {
          ...
          if (methods.pauseInvisible.visProp) {
            var evtname = methods.pauseInvisible.visProp.replace(/[H|h]idden/,
              '') + 'visibilitychange';
            document.addEventListener(evtname, function() {
              if (methods.pauseInvisible.isHidden()) {
                ...
                if (slider.started) slider.play(); //Initiated before, just play
                  ...
                  slider.vars.initDelay) : slider.play(); //Didn't init before: simply init or wait for it
              }
            });
          }
        },
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      if (asNav && slider.pagingCount === 1) slider.direction = (slider.currentItem <
        target) ? "next" : "prev";
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) ||
        ...
        if (asNav && withSync) {
          ...
          if (Math.ceil((target + 1) / slider.visible) - 1 !== slider.currentSlide &&
            ...
            slider.slides.removeClass(namespace + "active-slide").eq(target).addClass(
        ...
        if (!carousel) slider.slides.removeClass(namespace + 'active-slide').eq(
        ...
        if (!fade) {
          ...
          if (carousel) {
            ...
            slideString = (reverse) ? ((slider.count - 1) - target + slider.cloneOffset) *
              dimension : (target + slider.cloneOffset) * dimension;
          }
    ...
    slider.play = function() {
      ...
      slider.animatedSlides = slider.animatedSlides || setInterval(slider.animateSlides,
          ...
          posCalc = (function() {
            if (carousel) {
              return (special === "setTouch") ? pos :
                ...
                (reverse) ? slider.limit - (((slider.itemW + slider.vars
    ...
    slider.setup = function(type) {
      ...
      if (!fade) {
        ...
        if (slider.vars.animationLoop && !carousel) {
          ...
          slider.container.append(methods.uniqueID(slider.slides.first().clone()
      ...
      if (!carousel) slider.slides.removeClass(namespace + "active-slide").eq(
        slider.currentSlide).addClass(namespace + "active-slide");
    ...
    slider.doMath = function() {
      ...
      slider.w = (slider.viewport === undefined) ? slider.width() : slider.viewport
        .width();
      ...
      if (carousel) {
        ...
        slider.limit = (slider.pagingCount === 1) ? 0 :
          (slider.vars.itemWidth > slider.w) ? (slider.itemW * (slider.count -
          1)) + (slideMargin * (slider.count - 1)) : ((slider.itemW +
    ...
    slider.update = function(pos, action) {
      ...
      if (slider.vars.controlNav && !slider.manualControls) {
        if ((action === "add" && !carousel) || slider.pagingCount > slider.controlNav
          .length) {
    ...
    slider.addSlide = function(obj, pos) {
      ...
      if (vertical && reverse) {
        ...
        (pos !== undefined) ? slider.slides.eq(pos).before($obj) : slider.container
          .append($obj);
      }
...
define('ui.iscroll-lite', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
    ...
    var utils = (function() {
      ...
      var _vendor = (function() {
        ...
        for (; i < l; i++) {
          ...
          if (transform in _elementStyle) return vendors[i].substr(0,
            vendors[i].length - 1);
        }
      ...
      me.prefixPointerEvent = function(pointerEvent) {
        return window.MSPointerEvent ?
          'MSPointer' + pointerEvent.charAt(9).toUpperCase() + pointerEvent
          .substr(10) :
          pointerEvent;
      };
      ...
      me.momentum = function(current, start, time, lowerMargin, wrapperSize,
        ...
        if (destination < lowerMargin) {
          destination = wrapperSize ? lowerMargin - (wrapperSize / 2.5 * (
            speed / 8)) : lowerMargin;
      ...
      me.extend(me.ease = {}, {
        ...
        elastic: {
          ...
          fn: function(k) {
            ...
            return (e * Math.pow(2, -10 * k) * Math.sin((k - f / 4) * (2 *
              Math.PI) / f) + 1);
          }
        }
      });
    ...
    function IScroll(el, options) {
      ...
      this.options.preventDefault = !this.options.eventPassthrough && this.options
        .preventDefault;

      // If you want eventPassthrough I have to lock one of the axes
      this.options.scrollY = this.options.eventPassthrough == 'vertical' ?
        false : this.options.scrollY;
      this.options.scrollX = this.options.eventPassthrough == 'horizontal' ?
        false : this.options.scrollX;

      // With eventPassthrough we also need lockDirection mechanism
      this.options.freeScroll = this.options.freeScroll && !this.options.eventPassthrough;
      this.options.directionLockThreshold = this.options.eventPassthrough ? 0 :
        this.options.directionLockThreshold;

      this.options.bounceEasing = typeof this.options.bounceEasing == 'string' ?
        utils.ease[this.options.bounceEasing] || utils.ease.circular : this.options
        .bounceEasing;

      this.options.resizePolling = this.options.resizePolling === undefined ?
        60 : this.options.resizePolling;
    ...
    IScroll.prototype = {
      ...
      _start: function(e) {
        ...
        if (this.options.preventDefault && !utils.isBadAndroid && !utils.preventDefaultException(
      ...
      _move: function(e) {
        ...
        if (newX > 0 || newX < this.maxScrollX) {
          newX = this.options.bounce ? this.x + deltaX / 3 : newX > 0 ? 0 :
            this.maxScrollX;
        }
        if (newY > 0 || newY < this.maxScrollY) {
          newY = this.options.bounce ? this.y + deltaY / 3 : newY > 0 ? 0 :
            this.maxScrollY;
        }
      ...
      _end: function(e) {
        ...
        if (this.options.preventDefault && !utils.preventDefaultException(e.target,
        ...
        if (this.options.momentum && duration < 300) {
          momentumX = this.hasHorizontalScroll ? utils.momentum(this.x, this.startX,
            duration, this.maxScrollX, this.options.bounce ? this.wrapperWidth :
            0, this.options.deceleration) : {
            destination: newX,
            duration: 0
          };
          momentumY = this.hasVerticalScroll ? utils.momentum(this.y, this.startY,
            duration, this.maxScrollY, this.options.bounce ? this.wrapperHeight :
            0, this.options.deceleration) : {
            destination: newY,
            duration: 0
          };
      ...
      scrollToElement: function(el, time, offsetX, offsetY, easing) {
        ...
        pos.left = pos.left > 0 ? 0 : pos.left < this.maxScrollX ? this.maxScrollX :
          pos.left;
        pos.top = pos.top > 0 ? 0 : pos.top < this.maxScrollY ? this.maxScrollY :
          pos.top;

        time = time === undefined || time === null || time === 'auto' ? Math.max(
          Math.abs(this.x - pos.left), Math.abs(this.y - pos.top)) : time;
      ...
      _translate: function(x, y) {
        if (this.options.useTransform) {
          ...
          this.scrollerStyle[utils.style.transform] = 'translate(' + x + 'px,' +
            y + 'px)' + this.translateZ;
...
define('ui.modal', ['require', 'exports', 'module', 'jquery', './core',
  './ui.dimmer'
], function(require, exports, module) {
  'use strict';
...
define('ui.offcanvas', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.pinchzoom', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
    ...
    var definePinchZoom = function($) {
      ...
      PinchZoom.prototype = {
        ...
        scaleZoomFactor: function(scale) {
          ...
          this.zoomFactor = Math.min(this.options.maxZoom, Math.max(this.zoomFactor,
        ...
        drag: function(center, lastCenter) {
          if (lastCenter) {
            if (this.options.lockDragAxis) {
              ...
              if (Math.abs(center.x - lastCenter.x) > Math.abs(center.y -
                lastCenter.y)) {
                this.addOffset({
        ...
        sanitizeOffsetAnimation: function() {
          var targetOffset = this.sanitizeOffset(this.offset),
            ...
            updateProgress = (function(progress) {
              this.offset.x = startOffset.x + progress * (targetOffset.x -
                startOffset.x);
              this.offset.y = startOffset.y + progress * (targetOffset.y -
                startOffset.y);
              this.update();
            }).bind(this);
        ...
        update: function() {
          ...
          setTimeout((function() {
            ...
            var zoomFactor = this.getInitialZoomFactor() * this.zoomFactor,
              ...
              transform3d = 'scale3d(' + zoomFactor + ', ' + zoomFactor +
              ',1) ' +
...
define('ui.popover', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
    var $ = require('jquery');
    var UI = require('./core');
...
define('ui.progress', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
    ...
    var Progress = (function() {
      ...
      NProgress.configure = function(options) {
        ...
        for (key in options) {
          value = options[key];
          if (value !== undefined && options.hasOwnProperty(key)) Settings[
            key] = value;
        }
...
define('ui.pureview', ['require', 'exports', 'module', 'jquery', './core',
  './ui.pinchzoom', './util.hammer'
], function(require, exports, module) {
  'use strict';
  ...
  PureView.prototype.setScrollbar = function() {
    var bodyPaddingRight = parseInt((this.$body.css('padding-right') || 0),
      10);
    if (this.scrollbarWidth) {
...
define('ui.scrollspy', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.scrollspynav', ['require', 'exports', 'module', 'jquery', './core',
  './ui.smooth-scroll'
], function(require, exports, module) {
  'use strict';
  ...
  function Plugin(option) {
    return this.each(function() {
      ...
      if (!data) {
        $this.data('am.scrollspynav', (data = new ScrollSpyNav(this,
          options)));
      }
...
define('ui.share', ['require', 'exports', 'module', './ui.modal', 'jquery',
  './core', './util.qrcode'
], function(require, exports, module) {
  'use strict';
...
define('ui.smooth-scroll', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.sticky', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('ui.tabs', ['require', 'exports', 'module', 'jquery', './core',
  './util.hammer'
], function(require, exports, module) {
  'use strict';
...
define('util.cookie', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('util.fullscreen', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('util.qrcode', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    var $ = require('jquery');
    require('./core');
    ...
    qrcode.prototype.createDefault = function(qrCodeAlg) {
      ...
      if (canvas.getContext)
        return this.createCanvas(qrCodeAlg);
      if (!!document.createElementNS && !!document.createElementNS(SVG_NS,
        'svg').createSVGRect)
        return this.createSVG(qrCodeAlg);
      return this.createTable(qrCodeAlg);
    };
    ...
    qrcode.prototype.createTable = function(qrCodeAlg) {
      ...
      // 绘制二维码
      foreTd = '<td style="border:0px; margin:0px; padding:0px; width:' + tileW +
        'px; background-color: ' + this.options.foreground + '"></td>',
      backTd = '<td style="border:0px; margin:0px; padding:0px; width:' + tileW +
        'px; background-color: ' + this.options.background + '"></td>',
      l = qrCodeAlg.getModuleCount();

      for (var row = 0; row < l; row++) {
        s.push('<tr style="border:0px; margin:0px; padding:0px; height: ' +
          tileH + 'px">');
    ...
    qrcode.prototype.createSVG = function(qrCodeAlg) {
      var x, dx, y, dy,
        ...
        svg = '<svg xmlns="http://www.w3.org/2000/svg" ' + 'width="' + this.options
        .width + 'px" height="' + this.options.height + 'px" ' +
      ...
      setupPositionProbePattern: function(row, col) {
        ...
        for (var r = -1; r <= 7; r++) {
          ...
          for (var c = -1; c <= 7; c++) {
            ...
            if ((0 <= r && r <= 6 && (c == 0 || c == 6)) || (0 <= c && c <= 6 &&
              (r == 0 || r == 6)) || (2 <= r && r <= 4 && 2 <= c && c <= 4)) {
          ...
          for (var col = 0; col < moduleCount; col++) {
            ...
            if (col < moduleCount - 6) {
              if (current && !qrCode.modules[row][col + 1] && qrCode.modules[
                row][col + 2] && qrCode.modules[row][col + 3] && qrCode.modules[
                row][col + 4] && !qrCode.modules[row][col + 5] && qrCode.modules[
                row][col + 6]) {
                if (col < moduleCount - 10) {
                  if (qrCode.modules[row][col + 7] && qrCode.modules[row][col +
                    8
                  ] && qrCode.modules[row][col + 9] && qrCode.modules[row][
                    col + 10
                  ]) {
                    lostPoint += 40;
                  }
                } else if (col > 3) {
                  if (qrCode.modules[row][col - 1] && qrCode.modules[row][col -
                    2
                  ] && qrCode.modules[row][col - 3] && qrCode.modules[row][
                    col - 4
                  ]) {
                    lostPoint += 40;
                  }
          ...
          for (var row = 0; row < moduleCount; row++) {
            ...
            if (row < moduleCount - 6) {
              if (current && !qrCode.modules[row + 1][col] && qrCode.modules[
                row + 2][col] && qrCode.modules[row + 3][col] && qrCode.modules[
                row + 4][col] && !qrCode.modules[row + 5][col] && qrCode.modules[
                row + 6][col]) {
                if (row < moduleCount - 10) {
                  if (qrCode.modules[row + 7][col] && qrCode.modules[row + 8]
                    [col] && qrCode.modules[row + 9][col] && qrCode.modules[
                      row + 10][col]) {
                    lostPoint += 40;
                  }
                } else if (row > 3) {
                  if (qrCode.modules[row - 1][col] && qrCode.modules[row - 2]
                    [col] && qrCode.modules[row - 3][col] && qrCode.modules[
                      row - 4][col]) {
                    lostPoint += 40;
                  }
                }
 ...
 */
    ...
    QRCodeAlg.prototype.getRightType = function() {
      for (var typeNumber = 1; typeNumber < 41; typeNumber++) {
        ...
        if (this.utf8bytes.length + lengthBytes < totalDataCount || typeNumber ==
          40) {
...
define('accordion', ['require', 'exports', 'module', './core', './ui.collapse',
  'jquery'
], function(require, exports, module) {
  'use strict';
...
define('divider', ['require', 'exports', 'module'], function(require, exports,
  module) {
  'use strict';
...
define('duoshuo', ['require', 'exports', 'module', 'jquery', './core'],
  function(require, exports, module) {
    'use strict';
...
define('figure', ['require', 'exports', 'module', './core', './ui.pureview',
  'jquery'
], function(require, exports, module) {
  'use strict';
...
define('footer', ['require', 'exports', 'module', 'jquery', './core',
  './ui.modal', './ui.add2home', './util.cookie'
], function(require, exports, module) {
  'use strict';
...
define('gallery', ['require', 'exports', 'module', 'jquery', './core',
  './ui.pureview'
], function(require, exports, module) {
  'use strict';
...
define('gotop', ['require', 'exports', 'module', 'jquery', './core',
  './ui.smooth-scroll'
], function(require, exports, module) {
  'use strict';
...
define('header', ['require', 'exports', 'module', 'jquery'], function(require,
  exports, module) {
  'use strict';
...
define('intro', ['require', 'exports', 'module', 'jquery'], function(require,
  exports, module) {
  'use strict';
...
define('list_news', ['require', 'exports', 'module', 'jquery'], function(
  require, exports, module) {
  'use strict';
...
define('map', ['require', 'exports', 'module', './core', 'jquery'], function(
  require, exports, module) {
...
define('mechat', ['require', 'exports', 'module', 'jquery'], function(require,
  exports, module) {
  'use strict';
...
define('menu', ['require', 'exports', 'module', 'jquery', './core',
  './ui.offcanvas', './ui.collapse', './ui.iscroll-lite'
], function(require, exports, module) {
  'use strict';
  ...
  var menuInit = function() {
    ...
    $autoCloseOffCanvas.find('a').not('.am-parent>a').on('click', function(
      e) {
...
define('navbar', ['require', 'exports', 'module', 'jquery', './core',
  './ui.modal', './ui.share', './util.qrcode'
], function(require, exports, module) {
  'use strict';
  ...
  function navbarInit() {
    ...
    var configItems = $navBarNav.attr('class') &&
      parseInt($navBarNav.attr('class').match(/sm-block-grid-(\d+)/)[1]) || 3;
...
define('pagination', ['require', 'exports', 'module', 'jquery'], function(
  require, exports, module) {
  'use strict';
...
define('paragraph', ['require', 'exports', 'module', 'jquery', './core',
  './ui.pureview', './ui.iscroll-lite'
], function(require, exports, module) {
  'use strict';
...
define('slider', ['require', 'exports', 'module', 'jquery', './core',
  './ui.flexslider'
], function(require, exports, module) {
  'use strict';
...
define('sohucs', ['require', 'exports', 'module', 'jquery'], function(require,
  exports, module) {
  'use strict';
...
define('tabs', ['require', 'exports', 'module', 'jquery', './core', './ui.tabs'],
  function(require, exports, module) {
    'use strict';
...
define('titlebar', ['require', 'exports', 'module', 'jquery'], function(require,
  exports, module) {
  'use strict';
